...
<?php
	...
	function getItemLists(){
		...
		for($i=0; $i<$arrlength;$i++){
			$j = $i+100; //naming for available items in numbarical number starting from 100;
			$str =  '<div id="parentdiv" class="list-group-item list-group-item-action" onclick="toggleCheckbox('.$j.')">'.$itemNames[$i].' '.'<input id="'.$j.'" type="checkbox" checked value="'.$ids[$i].'" name = "values1[]" /> </div>';
	...
	function getAvailableItemLists(){
		...
		for($i=0; $i<$arrlength;$i++){
			$j = $i+10000; //naming for special in numbarical number starting from 10000;
			$str =  '<div id="parentdiv" class="list-group-item list-group-item-action" onclick="toggleCheckbox('.$j.')">'.$itemNames[$i].' '.'<input id="'.$j.'" type="checkbox" value="'.$ids[$i].'" name = "values2[]" /> </div>';
