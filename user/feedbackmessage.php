				...
				<div class="col-md-12 col-sm-12 col-xs-12">
	                <div class="isa_success">
					     ...
					     <?php
					     	if(!$error){ ?>
					     		Message is sent!
					     		<p style="font-size: 15px;">Thanks for your feedback!</p> <?php
					     	}
					     	else {?>
					     		Message can't be sent at this moment
					     		<p style="font-size: 15px;">Please, Try again Later!</p> <?php
					     	}
					     ?>
					</div>
	            </div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-sm-3 col-xs-3" align="left">
					  <a class="btn" id="addmore" href="home.php#availableITEM">BACK</a>
	            </div>
				<div class="col-md-3 col-sm-3 col-xs-3" align="center"></div>
