			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
	                <div class="isa_success">
					     ...
					     Order Confirmed!
					     <p style="font-size: 15px;">Please be paitient, your foods will be served soon.</p>
					</div>
	            </div>
			</div>
		</div>	
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-sm-3 col-xs-3" align="left">
					  <a class="btn" id="addmore" href="home.php#availableITEM">HOME</a>
	            </div>
				<div class="col-md-3 col-sm-3 col-xs-3" align="left">
					  <a class="btn" id="placeorder" href="logout.php">LOGOUT</a>
	            </div>
				<div class="col-md-3 col-sm-3 col-xs-3" align="center"></div>
